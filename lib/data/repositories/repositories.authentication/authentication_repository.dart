...
import 'package:untitled2_ecom/features/authentication/screens/signup/venify_email.dart';
...
class AuthenticationRepository extends GetxController {
  ...
  void screenRedirect() async {
    ...
    if (user != null) {
      if (user.emailVerified) {
        ...
        // التأكد من استدعاء الإشعارات وربطها بالحساب
        Get.offAll(() => const NavigationMenu());
      } else {
        Get.offAll(() => VenifyEmailScreen(email: _auth.currentUser?.email));
      }
    } else {
      deviceStorage.writeIfNull("isFirstTime", true);
      deviceStorage.read("isFirstTime") != null
          ? Get.offAll(() => LogineScreen())
  ...
  Future<UserCredential?> signInWithGoogle() async {
    try {
      ...
      if (kDebugMode) print("somthing went wrong, pleas try agin");
      return null;
    }
  }
