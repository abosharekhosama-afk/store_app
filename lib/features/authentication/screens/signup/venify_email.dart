...
import 'package:untitled2_ecom/features/authentication/controllers/signup/verify_email_controller.dart';
...
class VenifyEmailScreen extends StatelessWidget {
  const VenifyEmailScreen({super.key, this.email});
  final String? email;
  @override
