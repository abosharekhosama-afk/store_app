...
class THelperFunctions {
  static Color? getColor(String value) {
    ...
    if (value == 'Green' || value == 'اخضر') {
      return Colors.green;
    } else if (value == 'Green' || value == 'اخضر') {
      return Colors.green;
    } else if (value == 'Red' || value == 'احمر') {
      return Colors.red;
    } else if (value == 'Blue' || value == 'ازرق') {
      return Colors.blue;
    } else if (value == 'Pink' || value == 'زهري' || value == 'وردي') {
      return Colors.pink;
    } else if (value == 'Grey' || value == 'رمادي' || value == 'سكني') {
      return Colors.grey;
    } else if (value == 'Purple' || value == 'بنفسجي') {
      return Colors.purple;
    } else if (value == 'Black' || value == 'اسود') {
      return Colors.black;
    } else if (value == 'White' || value == 'ابيض') {
      return Colors.white;
    } else if (value == 'Yellow' || value == 'اصفر') {
      return Colors.yellow;
    } else if (value == 'Orange' || value == 'برتقالي' || value == 'اورنج') {
      return Colors.deepOrange;
    } else if (value == 'Brown' || value == 'بني') {
      return Colors.brown;
    } else if (value == 'Teal' || value == 'جنزاري') {
      return Colors.teal;
    } else if (value == 'Indigo' || value == 'حبري') {
